...
@Component({
  selector: 'app-c32',
  templateUrl: './c32.page.html',
  styleUrls: ['./c32.page.scss'],
})



export class C32Page implements OnInit {
  ...
  verhome(){
    ...
    const alert = await this.alertCtrl.create({
      ...
      buttons: [ {
        ...
        handler: () => {
          console.log('da');
          this.daexamen = true;
          document.getElementById("titulo").innerHTML = "<ion-title id='titulo'>32 Hrs CON Examen</ion-title>";
        }
      },,  {
        ...
        handler: () => {
          ...
          document.getElementById("titulo").innerHTML = "<ion-title id='titulo'>32 Hrs SIN Examen</ion-title>";
        }
      }]
    });
   ...
   async calcular(){
    ...
    if (this.epe1 == undefined || this.epe2 == undefined || this.epe3 == undefined || this.eva1 == undefined || this.eva2 == undefined || this.examen == undefined) {
      ...
      await alert.present();}
        ...
        if (this.epe1 > 7 || this.epe2 > 7 || this.epe3 > 7 || this.eva1 > 7 || this.eva2 > 7 || this.examen > 7) {
      ...
      if(this.daexamen == false){
        ...
        this.examen = null;
            ...
            if (this.epe1 < 1 || this.epe2 < 1 || this.epe3 < 1 || this.eva1 < 1 || this.eva2 < 1 || this.examen < 1) {
              ...
              if(this.daexamen == false){
                ...
                if (this.daexamen == false && this.epe1 < 4 || this.epe2 < 4 || this.epe3 < 4 ) {
                  ...
                  await alert.present();
                    ...
                    let cleanevas =(this.eva1 + this.eva2 /2);
                ...
                if (this.daexamen ==true) {
                  ...
                  let cleano =(this.epe1*0.07) + (this.epe2*0.14) + (this.epe3*0.21)+ (this.eva1*0.14) + (this.eva2*0.14) + (this.examen*0.30);
                  this.resultado = cleano;
    
                  this.navCntrl.navigateForward(`/c32r/${this.epe1}/${this.epe2}/${this.epe3}/${this.eva1}/${this.eva2}/${this.examen}/${this.resultado}/${this.daexamen}`);             
        
                  
                }else{
                let cleano =(this.epe1*0.10) + (this.epe2*0.20) + (this.epe3*0.30)+ (this.eva1*0.20)+ (this.eva2*0.20);
              this.resultado = cleano;
