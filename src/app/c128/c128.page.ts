...
@Component({
  selector: 'app-c128',
  templateUrl: './c128.page.html',
  styleUrls: ['./c128.page.scss'],
})



export class c128Page implements OnInit {
  ...
  verhome(){
    ...
    const alert = await this.alertCtrl.create({
      ...
      buttons: [ {
        ...
        handler: () => {
          console.log('da');
          this.daexamen = true;
          document.getElementById("titulo").innerHTML = "<ion-title id='titulo'>128 Hrs CON Examen</ion-title>";
        }
      },,  {
        ...
        handler: () => {
          ...
          document.getElementById("titulo").innerHTML = "<ion-title id='titulo'>c128 Hrs SIN Examen</ion-title>";
        }
      }]
    });
   ...
   async calcular(){
    ...
    if (this.epe1 == undefined || this.epe2 == undefined || this.epe3 == undefined || this.epe4 == undefined || this.eva1 == undefined || this.eva2 == undefined || this.eva3 == undefined || this.eva4 == undefined || this.examen == undefined) {
      ...
      await alert.present();}
        ...
        if (this.epe1 > 7 || this.epe2 > 7 || this.epe3 > 7 || this.epe4 > 7 || this.eva1 > 7 || this.eva2 > 7 || this.eva3 > 7 || this.eva4 > 7 || this.examen > 7) {
      ...
      if(this.daexamen == false){
        ...
        this.examen = null;
            ...
            if (this.epe1 < 1 || this.epe2 < 1 || this.epe3 < 1 || this.epe4 < 1 || this.eva1 < 1 || this.eva2 < 1 || this.eva3 < 1 || this.eva4 < 1 || this.examen < 1) {
              ...
              if(this.daexamen == false){
                ...
                if (this.daexamen == false && this.epe1 < 4 || this.epe2 < 4 || this.epe3 < 4 || this.epe4 < 4) {
                  ...
                  await alert.present();
                    ...
                    let cleanevas =(this.eva1 + this.eva2 + this.eva3 + this.eva4/4);
                ...
                if (this.daexamen ==true) {
                  ...
                  let cleano =(this.epe1*0.07) + (this.epe2*0.105) + (this.epe3*0.175)+ (this.epe4*0.175)+ (this.eva1*0.035)+ (this.eva2*0.035)+ (this.eva3*0.035)+ (this.eva4*0.07) + (this.examen*0.30);
                  this.resultado = cleano;
    
              this.navCntrl.navigateForward(`/c128r/${this.epe1}/${this.epe2}/${this.epe3}/${this.epe4}/${this.eva1}/${this.eva2}/${this.eva3}/${this.eva4}/${this.examen}/${this.resultado}/${this.daexamen}`);             
        
                  
                }else{
                  let cleano =(this.epe1*0.10) + (this.epe2*0.15) + (this.epe3*0.25)+ (this.epe4*0.25)+ (this.eva1*0.05)+ (this.eva2*0.05)+ (this.eva3*0.05)+ (this.eva4*0.10);
              this.resultado = cleano;
