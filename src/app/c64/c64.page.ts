...
@Component({
  selector: 'app-c64',
  templateUrl: './c64.page.html',
  styleUrls: ['./c64.page.scss'],
})



export class C64Page implements OnInit {
    ...
    const alert = await this.alertCtrl.create({
      ...
      buttons: [ {
        ...
        handler: () => {
          console.log('da');
          this.daexamen = true;
          document.getElementById("titulo").innerHTML = "<ion-title id='titulo'>64 Hrs CON Examen</ion-title>";
        }
      },,  {
        ...
        handler: () => {
          ...
          document.getElementById("titulo").innerHTML = "<ion-title id='titulo'>64 Hrs SIN Examen</ion-title>";
        }
      }]
    });
            ...
            if (this.epe1 < 1 || this.epe2 < 1 || this.epe3 < 1 || this.eva1 < 1 || this.eva2 < 1 || this.eva3 < 1 || this.examen < 1) {
              ...
              if(this.daexamen == false){
                ...
                if (this.daexamen ==true) {
                  ...
                  this.navCntrl.navigateForward(`/c64r/${this.epe1}/${this.epe2}/${this.epe3}/${this.eva1}/${this.eva2}/${this.eva3}/${this.examen}/${this.resultado}/${this.daexamen}`);             
